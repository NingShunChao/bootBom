...
;(function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        init: function () {
            ...
            if (this.isIE() <= 9) {
                $this.find("li.active").has("ul").children("ul").collapse(
                    "show");
                $this.find("li").not(".active").has("ul").children(
                    "ul").collapse("hide");
            } else {
            ...
            $this.find("li").has("ul").children("a").on(
                "click" + "." + pluginName, function (e) {
                    ...
                    $(this).parent("li").toggleClass("active").children(
                        "ul").collapse("toggle");

                    if ($toggle) {
                        $(this).parent("li").siblings().removeClass(
                            "active").children("ul.in").collapse("hide");
                    }
