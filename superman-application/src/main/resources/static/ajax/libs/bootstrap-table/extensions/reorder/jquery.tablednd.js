  ...
  $(document).ready(function () {
    ...
    $('table').each(function () {
      if ($(this).data('table') === 'dnd') {
        ...
        $(this).tableDnD({
          onDragStyle: $(this).data('ondragstyle') && parseStyle(
              $(this).data('ondragstyle')) || null,
          onDropStyle: $(this).data('ondropstyle') && parseStyle(
              $(this).data('ondropstyle')) || null,
          onDragClass: $(this).data('ondragclass') === undefined
              && "tDnD_whileDrag" || $(this).data('ondragclass'),
          onDrop: $(this).data('ondrop') && new Function('table', 'row',
              $(this).data('ondrop')), // 'return eval("'+$(this).data('ondrop')+'");') || null,
          onDragStart: $(this).data('ondragstart') && new Function('table',
              'row', $(this).data('ondragstart')), // 'return eval("'+$(this).data('ondragstart')+'");') || null,
          onDragStop: $(this).data('ondragstop') && new Function('table', 'row',
              $(this).data('ondragstop')),
          ...
          serializeRegexp: $(this).data('serializeregexp') && new RegExp(
  ...
  jQuery.tableDnD = {
    ...
    makeDraggable: function (table) {
      ...
      && $(config.dragHandle, table).each(function () {
        ...
        $(this).bind(startEvent, function (e) {
          $.tableDnD.initialiseDrag($(this).parents('tr')[0], table, this, e,
              config);
          return false;
        });
      })
      ...
      || $(table.rows).each(function () {
        ...
        if (!$(this).hasClass("nodrag")) {
          $(this).bind(startEvent, function (e) {
            if (e.target.tagName === "TD" && event.target.className
                !== "nodrag") {
    ...
    moveVerticle: function (moving, currentRow) {
      ...
      if (0 !== moving.vertical
        ...
        0 > moving.vertical
        && this.dragObject.parentNode.insertBefore(this.dragObject,
    ...
    processMouseup: function () {
      ...
      && $(this.currentTable.rows).first().find('td:first').children().each(
          function () {
