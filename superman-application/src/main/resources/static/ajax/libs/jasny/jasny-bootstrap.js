...
+function ($) {
  ...
  OffCanvas.prototype.calcPlacement = function () {
    ...
    this.placement = horizontal >= vertical ? ab('left', 'right') : ab('top',
        'bottom')
  ...
  OffCanvas.prototype.slide = function (elements, offset, callback) {
    ...
    elements.each(function () {
      if ($(this).css(placement) !== 'auto') {
        $(this).css(placement,
            (parseInt($(this).css(placement), 10) || 0) + offset)
      }

      if ($(this).css(opposite) !== 'auto') {
        $(this).css(opposite,
            (parseInt($(this).css(opposite), 10) || 0) - offset)
      }
    })
  ...
  OffCanvas.prototype.disableScrolling = function () {
    ...
    if ($('body').width() > bodyWidth) {
      var padding = parseInt($('body').css(prop), 10) + $('body').width()
          - bodyWidth
  ...
  OffCanvas.prototype.show = function () {
    ...
    if (elements.index(this.$element) !== -1) {
      $(this.$element).data('offcanvas-style',
    ...
    elements.addClass('canvas-sliding').each(function () {
      if ($(this).data('offcanvas-style') === undefined) {
        $(this).data(
            'offcanvas-style', $(this).attr('style') || '')
      }
      if ($(this).css('position') === 'static') {
        $(this).css('position',
            'relative')
      }
      if (($(this).css(placement) === 'auto' || $(this).css(placement)
          === '0px') &&
          ($(this).css(opposite) === 'auto' || $(this).css(opposite)
              === '0px')) {
  ...
  OffCanvas.prototype.hide = function (fast) {
    ...
    var complete = function () {
      ...
      elements.add(this.$element).add('body').each(function () {
        $(this).attr('style', $(this).data('offcanvas-style')).removeData(
            'offcanvas-style')
      })
  ...
  OffCanvas.prototype.recalc = function () {
    if (this.$calcClone.css('display') === 'none' || (this.state !== 'slid'
        && this.state !== 'slide-in')) {
      return
    }
  ...
  $.fn.offcanvas = function (option) {
    return this.each(function () {
      ...
      var options = $.extend({}, OffCanvas.DEFAULTS, $this.data(),
          typeof option === 'object' && option)

      if (!data) {
        $this.data('bs.offcanvas',
  ...
  $(document).on('click.bs.offcanvas.data-api', '[data-toggle=offcanvas]',
      function (e) {
        var $this = $(this), href
...
+function ($) {
  ...
  var Rowlink = function (element, options) {
    ...
    this.$element.on('click.bs.rowlink', 'td:not(.rowlink-skip)',
  ...
  $(document).on('click.bs.rowlink.data-api', '[data-link="row"]',
      function (e) {
...
+function ($) {
  ...
  Inputmask.prototype.keydownEvent = function (e) {
    ...
    if (k == 8 || k == 46 || (isIphone && k == 127)) {
      ...
      if (end - begin === 0) {
        begin = k != 46 ? this.seekPrev(begin) : (end = this.seekNext(
            begin - 1))
  ...
  Inputmask.prototype.checkVal = function (allow) {
    ...
    for (var i = 0, pos = 0; i < len; i++) {
      ...
      } else if (this.buffer[i] == test.charAt(pos) && i
          != this.partialPosition) {
        pos++
        lastMatch = i
      }
    }
    if (!allow && lastMatch + 1 < this.partialPosition) {
      ...
      if (!allow) {
        this.$element.val(
            this.$element.val().substring(0, lastMatch + 1))
      }
    }
  ...
  $.fn.inputmask = function (options) {
    return this.each(function () {
      ...
      if (!data) {
        $this.data('bs.inputmask',
            (data = new Inputmask(this, options)))
      }
    })
  }
    ...
    this.$element.find('[data-dismiss="fileinput"]').on('click.bs.fileinput',
      ...
      Fileinput.prototype.change = function (e) {
        ...
        if (this.$preview.length > 0 && (typeof file.type !== "undefined"
            ? file.type.match(/^image\/(gif|png|jpeg)$/) : file.name.match(
                /\.(gif|png|jpe?g)$/i)) && typeof FileReader !== "undefined") {
          ...
          reader.onload = function (re) {
            ...
            if (preview.css('max-height') != 'none') {
              $img.css('max-height',
                  parseInt(preview.css('max-height'), 10) - parseInt(
                  preview.css('padding-top'), 10) - parseInt(
                  preview.css('padding-bottom'), 10) - parseInt(
                  preview.css('border-top'), 10) - parseInt(
                  preview.css('border-bottom'), 10))
            }
