(function (jQuery) {
  ...
  JSONFormatter = (function () {
    ...
    JSONFormatter.prototype.valueToHTML = function (value, level) {
      ...
      valueType = Object.prototype.toString.call(value).match(
          /\s(.+)]/)[1].toLowerCase();
    ...
    JSONFormatter.prototype.stringToHTML = function (value) {
      ...
      if (/^(http|https|file):\/\/[^\s]+$/i.test(value)) {
        return "<a href=\"" + (this.htmlEncode(value))
            + "\"><span class=\"q\">\"</span>" + (this.jsString(value))
            + "<span class=\"q\">\"</span></a>";
      } else {
        multilineClass = '';
        ...
        return "<span class=\"string" + multilineClass + "\">\"" + value
            + "\"</span>";
      }
    };
    ...
    JSONFormatter.prototype.arrayToHTML = function (array, level) {
      ...
      if (hasContents) {
        ...
        return "[<ul class=\"array level" + level + collapsible + "\">" + output
            + "</ul>]";
      } else {
        return '[ ]';
      }
    ...
    JSONFormatter.prototype.objectToHTML = function (object, level) {
      ...
      for (prop in object) {
        value = object[prop];
        hasContents = true;
        output += "<li><span class=\"prop\"><span class=\"q\">\"</span>"
            + (this.jsString(prop)) + "<span class=\"q\">\"</span></span>: "
      ...
      if (hasContents) {
        collapsible = level === 0 ? '' : ' collapsible';
        return "{<ul class=\"obj level" + level + collapsible + "\">" + output
            + "</ul>}";
      } else {
        return '{ }';
      }
  ...
  return $.fn.JSONView = function () {
    ...
    if (JSONView[args[0]] != null) {
      ...
      return this.each(function () {
        ...
        if (args[1] != null) {
          level = args[1];
          return $this.find(".jsonview .collapsible.level" + level).siblings(
              '.collapser').each(function () {
            return JSONView[method](this);
          });
        } else {
          return $this.find('.jsonview > ul > li > .collapsible').siblings(
              '.collapser').each(function () {
            return JSONView[method](this);
          });
        }
      ...
      return this.each(function () {
        ...
        for (_i = 0, _len = items.length; _i < _len; _i++) {
          ...
          if (item.parentNode.nodeName === 'LI') {
            _results.push(
                Collapser.bindEvent(item.parentNode, options.collapsed));
          } else {
