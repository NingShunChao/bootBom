...
;(function () {
  ...
  function setup($) {
    ...
    var ie6 = /MSIE 6.0/.test(navigator.userAgent) && !/MSIE 8.0/.test(
        navigator.userAgent);
    ...
    function install(el, opts) {
      ...
      if (msie || opts.forceIframe) {
        lyr1 = $('<iframe class="blockUI" style="z-index:' + (z++)
      ...
      if (opts.theme) {
        ...
        lyr2 = $('<div class="blockUI blockOverlay" style="z-index:' + (z++)
      ...
      if (ie6 || expr) {
        ...
        $.each(layers, function (i, o) {
          ...
          if (i < 2) {
            ...
            var top = (opts.css && opts.css.top) ? parseInt(opts.css.top, 10)
                : 0;
