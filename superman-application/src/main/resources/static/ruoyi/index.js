...
$(function () {
  ...
  function scrollToTab(element) {
    ...
    if ($(".page-tabs-content").outerWidth() < visibleWidth) {
      ...
      if ((visibleWidth - $(element).next().outerWidth(true))
          > marginRightVal) {
  ...
  function closeTab() {
    ...
    if ($(this).parents('.menuTab').hasClass('active')) {
      ...
      if ($(this).parents('.menuTab').next('.menuTab').size()) {
        ...
        var activeId = $(this).parents('.menuTab').next('.menuTab:eq(0)').data(
            'id');
      ...
      if ($(this).parents('.menuTab').prev('.menuTab').size()) {
        var activeId = $(this).parents('.menuTab').prev('.menuTab:last').data(
            'id');
        ...
        if ($.common.isNotEmpty(panelUrl)) {
          $('.menuTab[data-id="' + panelUrl + '"]').addClass('active').siblings(
              '.menuTab').removeClass('active');
          $('.mainContent .RuoYi_iframe').each(function () {
