...
public class SysPasswordService
{
    ...
    public void validate(SysUser user, String password)
    {
        ...
        {
            AsyncManager.me().execute(AsyncFactory.recordLogininfor(loginName, CommonConstant.LOGIN_FAIL, MessageUtils.message("user.password.retry.limit.exceed", maxRetryCount)));
        ...
        if (!matches(user, password))
        {
            AsyncManager.me().execute(AsyncFactory
                .recordLogininfor(loginName, CommonConstant.LOGIN_FAIL, MessageUtils
                    .message("user.password.retry.limit.count", retryCount)));
            loginRecordCache.put(loginName, retryCount);
